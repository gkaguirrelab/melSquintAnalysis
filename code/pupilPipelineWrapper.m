...
pathParams.dataOutputDirFull = fullfile(pathParams.analysisBasePath,'Experiments','OLApproach_Squint',pathParams.protocol,'DataFiles');
...
for rr = 1:length(pathParams.runNames)
    ...
    'sceneParamsLB',sceneParams.LB, 'sceneParamsUB',sceneParams.UB, ...
