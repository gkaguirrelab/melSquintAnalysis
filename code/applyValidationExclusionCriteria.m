...
if strcmp(DirectionObject.describe.directionParams.baseName, 'LightFlux_chrom') % light flux pulses
    ...
    if isfield(DirectionObject.describe.directionParams, 'targetContrast')
    targetedReceptors = DirectionObject.describe.directionParams.targetContrast;
    else
        modulationType = DirectionObject.describe.directionParams.baseName;
       if contains(modulationType, 'LightFlux')
           targetedReceptors = [4 4 4 4];
       elseif contains(modulationType, 'MaxMel')
           targetedReceptors = [0 0 0 4];
       elseif contains(modulationType, 'MaxLMS')
           targetedReceptors = [4 4 4 0];
       end
